...
def create_branch(ticket_number: str) -> str:
    """
    Fetch the latest GitHub main branch and create a
    unique feature branch directly from origin/main.
    """
    ...
    print("Fetching latest main from GitHub...")

    run_git_command(
        ["git", "fetch", "origin", "main"]
    )

    print("Creating branch from origin/main...")
    ...
    print(
        f"Created unique branch from origin/main: "
        f"{branch_name}"
    )
